...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260912024914_ConfiguracaoMembrosWorkspace")]
    partial class ConfiguracaoMembrosWorkspace
    {
            ...
            modelBuilder.Entity("Domain.Entities.Workspace", b =>
                {
                    ...
                    b.HasIndex("ResponsavelCodigo", "ResponsavelEmail")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.Workspace", b =>
                {
                    b.HasOne("Domain.Entities.Usuario", "Responsavel")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Workspace", "ResponsavelCodigo", "ResponsavelEmail")
                        .HasPrincipalKey("Domain.Entities.Usuario", "Codigo", "Email")
                        .OnDelete(DeleteBehavior.Restrict);
