...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260919011244_AddDepartamentoTenant")]
    partial class AddDepartamentoTenant
    {
            ...
            modelBuilder.Entity("Domain.Entities.Workspace", b =>
                {
                    ...
                    b.HasIndex("ResponsavelId", "ResponsavelCodigo")
                        .IsUnique();

                    b.ToTable("Workspaces");
                });

            modelBuilder.Entity("Domain.Tenants.DepartamentoWorkspace", b =>
                {
                    b.Property<int>("WorkspaceId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("WorkspaceId", "WorkspaceCodigo", "DepartamentoId", "DepartamentoCodigo");

                    b.HasIndex("DepartamentoId", "DepartamentoCodigo");

                    b.ToTable("DepartamentoTenant", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Workspace", b =>
                {
                    b.HasOne("Domain.Entities.Usuario", "Responsavel")
                        .WithOne("Workspace")
                        .HasForeignKey("Domain.Entities.Workspace", "ResponsavelId", "ResponsavelCodigo")
                        .OnDelete(DeleteBehavior.Restrict);
