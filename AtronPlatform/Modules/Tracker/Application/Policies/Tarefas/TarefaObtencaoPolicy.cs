...
{
    public class TarefaObtencaoPolicy : ITarefaObtencaoPolicy
    {
        private const int EstadoFinalizadaId = 4;

        public Resultado AvaliarAssuncao(Tarefa tarefa, bool possuiResponsabilidadeGestao)
        {
        ...
        public Resultado AvaliarSolicitacao(Tarefa tarefa, bool possuiResponsabilidadeGestao)
        {
