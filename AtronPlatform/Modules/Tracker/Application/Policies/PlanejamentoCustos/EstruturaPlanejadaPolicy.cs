...
namespace Application.Policies.PlanejamentoCustos
{
    public sealed class EstruturaPlanejadaPolicy(IPlanejamentoCustoRepository planejamentoCustoRepository)
    {
