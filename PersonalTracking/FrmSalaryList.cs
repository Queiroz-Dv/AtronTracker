    ...
    public partial class FrmSalaryList : Form
    {
        ...
        private void FrmSalaryList_Load(object sender, EventArgs e)
        {
            ...
            if(!UserStatic.isAdmin)
            {
                btnUpdate.Hide();
                btnDelete.Hide();
                btnNew.Location = new System.Drawing.Point(212, 20);
                btnClose.Location = new System.Drawing.Point(350, 20);
                pnlForAdmin.Hide();
            }
        ...
        {
            DialogResult result = MessageBox.Show("Are you to delete this salary", "Warning", MessageBoxButtons.YesNo);
