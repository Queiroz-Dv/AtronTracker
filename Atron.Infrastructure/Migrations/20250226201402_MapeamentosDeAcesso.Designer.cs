...
namespace Atron.Infrastructure.Migrations
{
    ...
    [Migration("20250226201402_MapeamentosDeAcesso")]
    partial class MapeamentosDeAcesso
    {
            ...
            modelBuilder.Entity("Atron.Domain.Componentes.PropriedadeDeFluxoModulo", b =>
                {
                    ...
                    b.Property<string>("PropriedadesDeFluxoCodigo")
                        .HasColumnType("nvarchar(25)");

                    b.Property<int?>("PropriedadesDeFluxoId")
                        .HasColumnType("int");

                    b.HasKey("ModuloId", "ModuloCodigo", "PropriedadeDeFluxoId", "PropriedadeDeFluxoCodigo");

                    b.HasIndex("PropriedadesDeFluxoId", "PropriedadesDeFluxoCodigo");
            ...
            modelBuilder.Entity("Atron.Domain.Componentes.PropriedadeDeFluxoModulo", b =>
                {
                    ...
                    b.HasOne("Atron.Domain.Componentes.PropriedadesDeFluxo", "PropriedadesDeFluxo")
                        .WithMany()
                        .HasForeignKey("PropriedadesDeFluxoId", "PropriedadesDeFluxoCodigo");
