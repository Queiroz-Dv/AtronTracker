...
namespace PersonalTracking.DAL.DataAcess
{
	...
	public partial class PersonalTrackingDBDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteTASKSTATE(TASKSTATE instance);
		...
		public PersonalTrackingDBDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PersonalTrackingDBDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PersonalTrackingDBDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PersonalTrackingDBDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnIDChanging(int value);
    partial void OnIDChanged();
    partial void OnStateNaemChanging(string value);
    partial void OnStateNaemChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_StateNaem", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string StateNaem
		{
			get
			{
				return this._StateNaem;
			}
			set
			{
				if ((this._StateNaem != value))
				{
					this.OnStateNaemChanging(value);
					this.SendPropertyChanging();
					this._StateNaem = value;
					this.SendPropertyChanged("StateNaem");
					this.OnStateNaemChanged();
				}
			}
		}
