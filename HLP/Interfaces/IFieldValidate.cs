namespace HLP.Interfaces
{
    ...
    public interface IFieldValidate
    {
        ...
        void FieldIsEmptyMessage(string fieldName, string secondField);
        ...
        void FieldIsEmptyMessage(string fieldName, string secondField, string thirdField);
        ...
        void FieldIsEmptyMessage(string fieldName, string secondField, string thirdField, string fourthField);
        ...
        void FieldIsEmptyMessage(string fieldName, string secondField, string thirdField, string fourthField, string fifthField);
    }
