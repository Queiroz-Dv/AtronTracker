...
public class ResourceFoundationTests
{
    ...
    public void ResourcesDoTrackerDevemCarregarAsChavesPeloAssembly()
    {
        var casos = new[]
        {
            ...
            (NotificacaoInternaResource.ResourceManager, "Titulo_TarefaAtribuida", "Nova tarefa atribuída"),
    ...
    {
        Assert.Equal("Notificação marcada como lida.", NotificacaoInternaResource.Mensagem_NotificacaoMarcadaComoLida);
