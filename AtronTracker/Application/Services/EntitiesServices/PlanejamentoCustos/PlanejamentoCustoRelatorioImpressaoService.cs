    ...
    public class PlanejamentoCustoRelatorioImpressaoService : IPlanejamentoCustoRelatorioImpressaoService
    {
        ...
        public async Task<Resultado<string>> ObterHtmlRelatorioGeralAsync(int ano)
        {
            ...
            return relatorio.TeveFalha
                ...
                : Resultado<string>.Sucesso(MontarHtmlRelatorio(relatorio.Dados));
        }
        ...
        private static string MontarHtmlRelatorio(PlanejamentoCustoRelatorioGeralDTO relatorio)
        {
            var departamentosHtml = string.Join(string.Empty, relatorio.Departamentos.Select(MontarHtmlDepartamento));
        ...
        private static string MontarHtmlDepartamento(PlanejamentoCustoRelatorioDepartamentoDTO departamento)
        {
      ...
      <article>
        ...
        private static string MontarHtmlCargos(PlanejamentoCustoRelatorioDepartamentoDTO departamento)
        {
