...
namespace IoC
{
    public static class DepedencyInjectionAtronStock
    {
    ...
    public static class DependencyInjectionAtronStockMapping
    {
    ...
    public static class DependencyInjectionAtronStockValidador
    {
